...
# If you don't purchase health insurance near the beggining stages of life you will have to pay a fee depending on the accident.

 # Health Costs
heartAttack = 300    # Hospital fee.
carCrash = 1000  # Car crashes can lead to buying a new car, or paying for damage.
# If health < 25 bofore the accident, you will die immediately. Otherwise you will have to pay a fee depending on the damage to your body.
